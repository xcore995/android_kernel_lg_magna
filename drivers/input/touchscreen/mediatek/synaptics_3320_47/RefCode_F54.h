...
#define TPD_FUN(f)               pr_err(TPD_TAG"%s\n", __func__)
#define TPD_ERR(fmt, args...)    pr_err(TPD_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define TPD_LOG(fmt, args...)    pr_err(TPD_TAG fmt, ##args)
