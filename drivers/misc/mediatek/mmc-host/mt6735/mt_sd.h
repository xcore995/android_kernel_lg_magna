...
struct tag_msdc_hw_para {
	...
	unsigned int  clk_drv_sd_18;          /* clock pad driving for SD card at 1.8v sdr104 mode */
	unsigned int  cmd_drv_sd_18;          /* command pad driving for SD card at 1.8v sdr104 mode */
	unsigned int  dat_drv_sd_18;          /* data pad driving for SD card at 1.8v sdr104 mode */
	unsigned int  clk_drv_sd_18_sdr50;    /* clock pad driving for SD card at 1.8v sdr50 mode */
	unsigned int  cmd_drv_sd_18_sdr50;    /* command pad driving for SD card at 1.8v sdr50 mode */
	unsigned int  dat_drv_sd_18_sdr50;    /* data pad driving for SD card at 1.8v sdr50 mode */
	unsigned int  clk_drv_sd_18_ddr50;    /* clock pad driving for SD card at 1.8v ddr50 mode */
	unsigned int  cmd_drv_sd_18_ddr50;    /* command pad driving for SD card at 1.8v ddr50 mode */
	unsigned int  dat_drv_sd_18_ddr50;    /* data pad driving for SD card at 1.8v ddr50 mode */
	...
	unsigned int  rdsplsel;  // read: data line rising or falling latch fine tune selection
	unsigned int  wdsplsel;  // write: data line rising or falling latch fine tune selection
