/* mediatek/platform/mt6592/kernel/drivers/uart/uart.c
 *
 * (C) Copyright 2008
...
#else
		pr_debug("GPIO_UART_UTXD3_PIN is not properly set p2\n");
#endif
		break;
	default:
		break;
...
#else
		pr_debug("GPIO_UART_URXD4_PIN is not properly set\n");
#endif
		break;
	default:
		break;
...
#else
		pr_debug("GPIO_UART_URXD4_PIN is not properly set p2\n");
#endif
		break;
	default:
		break;
