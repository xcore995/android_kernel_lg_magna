...
*/
	...
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x020, TDSHP_Param[sharpGain][17] << 24 | TDSHP_Param[sharpGain][18] << 16);
	...
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x040, TDSHP_Param[sharpGain][23] << 24 | TDSHP_Param[sharpGain][24] << 16);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x04C, TDSHP_Param[sharpGain][25] << 24 | TDSHP_Param[sharpGain][26] << 16);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x058, TDSHP_Param[sharpGain][27] << 24 | TDSHP_Param[sharpGain][28] << 16);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x064, TDSHP_Param[sharpGain][29] << 28 | TDSHP_Param[sharpGain][30] << 24);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x068, TDSHP_Param[sharpGain][31] << 10 | TDSHP_Param[sharpGain][32] << 9);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x06C, TDSHP_Param[sharpGain][33] << 24 | TDSHP_Param[sharpGain][34] << 16);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x078, TDSHP_Param[sharpGain][35] << 24 | TDSHP_Param[sharpGain][36] << 16);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x028, TDSHP_Param[sharpGain][37] << 16 | TDSHP_Param[sharpGain][38] << 8);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x030, TDSHP_Param[sharpGain][39] << 24 | TDSHP_Param[sharpGain][40] << 20);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x034, TDSHP_Param[sharpGain][21] << 16 | TDSHP_Param[sharpGain][22] << 24);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x03C, TDSHP_Param[sharpGain][41] << 16 | TDSHP_Param[sharpGain][42] << 8);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x048, TDSHP_Param[sharpGain][43] << 16 | TDSHP_Param[sharpGain][44] << 8);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x054, TDSHP_Param[sharpGain][45] << 16 | TDSHP_Param[sharpGain][46] << 8);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x060, TDSHP_Param[sharpGain][47] << 16 | TDSHP_Param[sharpGain][48] << 8);
	...
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x074, TDSHP_Param[sharpGain][53] << 16 | TDSHP_Param[sharpGain][54] << 8);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x080, TDSHP_Param[sharpGain][55] << 16 | TDSHP_Param[sharpGain][56] << 8);
	...
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x218, TDSHP_Param[sharpGain][130] << 24 | TDSHP_Param[sharpGain][131] << 16);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x210, TDSHP_Param[sharpGain][132] << 24 | TDSHP_Param[sharpGain][133] << 16);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x220, TDSHP_Param[sharpGain][134] << 24 | TDSHP_Param[sharpGain][135] << 16);
	...
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x240, TDSHP_Param[sharpGain][149] << 24 | TDSHP_Param[sharpGain][150] << 16);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x238, TDSHP_Param[sharpGain][151] << 24 | TDSHP_Param[sharpGain][152] << 16);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x248, TDSHP_Param[sharpGain][153] << 24 | TDSHP_Param[sharpGain][154] << 16);
	...
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x268, TDSHP_Param[sharpGain][168] << 24 | TDSHP_Param[sharpGain][169] << 16);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x260, TDSHP_Param[sharpGain][170] << 24 | TDSHP_Param[sharpGain][171] << 16);
	DISP_REG_SET(DISPSYS_TDSHP_BASE + 0x270, TDSHP_Param[sharpGain][172] << 24 | TDSHP_Param[sharpGain][173] << 16);
