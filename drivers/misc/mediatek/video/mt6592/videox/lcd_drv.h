...
extern int m4u_invalid_tlb_all_stub(M4U_MODULE_ID_ENUM eModuleID);
extern int m4u_manual_insert_entry_stub(M4U_MODULE_ID_ENUM eModuleID, unsigned int EntryMVA, bool Lock);
/* --------------------------------------------------------------------------- */
...
/* LCD Controller Interface */
	...
	LCD_STATUS LCD_ConfigSerialIF(LCD_IF_ID id,
				      ...
				      UINT32 hw_cs,
				      UINT32 css,
				      UINT32 csh, UINT32 rd_1st, UINT32 rd_2nd, UINT32 wr_1st, UINT32 wr_2nd);
