...
static void disp_pwm_log(int level_1024, int log_type)
{
	...
	if (g_pwm_log_index == PWM_LOG_BUFFER_SIZE || level_1024 == 0) {
		if (log_type == MSG_LOG) {
			PWM_MSG("[PWM] disp_pwm (latest index=%2d): %5d(%4d %4d) %5d(%4d %4d) \
				%5d(%4d %4d) %5d(%4d %4d) %5d(%4d %4d)", (int)g_pwm_log_index,
				(int)g_pwm_log_buffer[0].value, (int)g_pwm_log_buffer[0].tsec, (int)g_pwm_log_buffer[0].tusec,
				(int)g_pwm_log_buffer[1].value, (int)g_pwm_log_buffer[1].tsec, (int)g_pwm_log_buffer[1].tusec,
				(int)g_pwm_log_buffer[2].value, (int)g_pwm_log_buffer[2].tsec, (int)g_pwm_log_buffer[2].tusec,
				(int)g_pwm_log_buffer[3].value, (int)g_pwm_log_buffer[3].tsec, (int)g_pwm_log_buffer[3].tusec,
				(int)g_pwm_log_buffer[4].value, (int)g_pwm_log_buffer[4].tsec, (int)g_pwm_log_buffer[4].tusec);
		} else {
			PWM_NOTICE("[PWM] disp_pwm (latest index=%2d): %5d(%4d %4d) %5d(%4d %4d) \
				%5d(%4d %4d) %5d(%4d %4d) %5d(%4d %4d)", (int)g_pwm_log_index,
				(int)g_pwm_log_buffer[0].value, (int)g_pwm_log_buffer[0].tsec, (int)g_pwm_log_buffer[0].tusec,
				(int)g_pwm_log_buffer[1].value, (int)g_pwm_log_buffer[1].tsec, (int)g_pwm_log_buffer[1].tusec,
				(int)g_pwm_log_buffer[2].value, (int)g_pwm_log_buffer[2].tsec, (int)g_pwm_log_buffer[2].tusec,
