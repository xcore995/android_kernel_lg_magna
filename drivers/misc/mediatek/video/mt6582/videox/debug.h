...
#define DISP_DRV_WARN(fmt, arg...) \
	do { \
		if (disp_drv_dbg_log) \
			DISP_LOG_PRINT(ANDROID_LOG_WARN, "DISP", fmt, ##arg); \
	} while (0)

#define DISP_DRV_INFO(fmt, arg...) \
	do { \
		if (disp_drv_dbg_info_log) \
			DISP_LOG_PRINT(ANDROID_LOG_INFO, "DISP", fmt, ##arg); \
	} while (0)

#define DISP_DRV_FUNC()	\
	do { \
		if (disp_drv_dbg_func_log) \
			DISP_LOG_PRINT(ANDROID_LOG_INFO, "DISP", "[Func]%s\n", __func__); \
	} while (0)
...
#define DISP_DRV_MSG(fmt, arg...) \
	DISP_LOG_PRINT(ANDROID_LOG_INFO, "DISP", fmt, ##arg)

#define DISP_DRV_ERR(fmt, arg...) \
	DISP_LOG_PRINT(ANDROID_LOG_ERROR, "DISP", fmt, ##arg)
...
#define MTKFB_INFO(fmt, arg...) \
	do { \
		if (mtkfb_dbg_log) \
			DISP_LOG_PRINT(ANDROID_LOG_INFO, "MTKFB", fmt, ##arg); \
	} while (0)
...
#define MTKFB_ERR(fmt, arg...) \
	DISP_LOG_PRINT(ANDROID_LOG_ERROR, "MTKFB", fmt, ##arg)
