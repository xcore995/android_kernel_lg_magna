...
extern "C" {
	...
	typedef struct mtk_dispif_info {
		...
		unsigned int lcmOriginalWidth;	/* for DFO Multi-Resolution feature, the original LCM Wdith */
		unsigned int lcmOriginalHeight;	/* for DFO Multi-Resolution feature, the original LCM Height */
	} mtk_dispif_info_t;
