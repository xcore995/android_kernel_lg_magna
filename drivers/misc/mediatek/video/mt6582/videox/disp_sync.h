...
#define XLOG_WARN(fmt, arg...) xlog_printk(ANDROID_LOG_WARN, "DISP/"LOG_TAG, fmt, ##arg)
#define XLOG_ERR(fmt, arg...) xlog_printk(ANDROID_LOG_ERROR, "DISP/"LOG_TAG, fmt, ##arg)
#define XLOG_AST(format, args...) xlog_printk(ANDROID_LOG_ASSERT , "DISP/"LOG_TAG, fmt, ##arg)
