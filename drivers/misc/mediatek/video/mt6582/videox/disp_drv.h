...
/* --------------------------------------------------------------------------- */
	...
	DISP_STATUS DISP_Auto_Capture_FB(unsigned int pvbuf, unsigned int wdma_out_fmt,
					 unsigned int bpp, unsigned int is_early_suspended,
					 int wdma_width, int wdma_height);
/* --------------------------------------------------------------------------- */
