...
#define ERROR_BUFFER_SIZE (16 * 1024)
#define FENCE_BUFFER_SIZE (16 * 1024)
#define DEBUG_BUFFER_SIZE (16 * 1024)
#define DUMP_BUFFER_SIZE (16 * 1024)
#define ERROR_BUFFER_COUNT 2
#define FENCE_BUFFER_COUNT 2
#define DEBUG_BUFFER_COUNT 2
#define DUMP_BUFFER_COUNT 2

/*
static char err_buffer[ERROR_BUFFER_COUNT][ERROR_BUFFER_SIZE];
static char fence_buffer[FENCE_BUFFER_COUNT][FENCE_BUFFER_SIZE];
static char dbg_buffer[DEBUG_BUFFER_COUNT][DEBUG_BUFFER_SIZE];
static char dump_buffer[DUMP_BUFFER_COUNT][DUMP_BUFFER_SIZE];
*/
	static char err_buffer_0[ERROR_BUFFER_SIZE];
	static char err_buffer_1[ERROR_BUFFER_SIZE];

	static char fence_buffer_0[FENCE_BUFFER_SIZE];
	static char fence_buffer_1[FENCE_BUFFER_SIZE];

	static char dbg_buffer_0[DEBUG_BUFFER_SIZE];
	static char dbg_buffer_1[DEBUG_BUFFER_SIZE];
	static char dump_buffer_0[DUMP_BUFFER_SIZE];
	static char dump_buffer_1[DUMP_BUFFER_SIZE];

static unsigned int dprec_logger_prop[DPREC_LOGGER_PR_NUM][2] = {
	{ERROR_BUFFER_SIZE, ERROR_BUFFER_COUNT},
	{FENCE_BUFFER_SIZE, FENCE_BUFFER_COUNT},
	{DEBUG_BUFFER_SIZE, DEBUG_BUFFER_COUNT},
	{DUMP_BUFFER_SIZE, DUMP_BUFFER_COUNT},
};


static DEFINE_SPINLOCK(dprec_logger_spinlock);
static unsigned int dprec_logger_id[DPREC_LOGGER_PR_NUM] = { 0, 0, 0, 0 };
...
#else
static char *dprec_logger_buffer[DPREC_LOGGER_PR_NUM][DPREC_LOGGER_BUFFER_COUNT] = {
	err_buffer_0, err_buffer_1,
	fence_buffer_0, fence_buffer_1,
	dbg_buffer_0, dbg_buffer_1,
	dump_buffer_0, dump_buffer_1
};
#endif
int dprec_logger_pr(unsigned int type, char *fmt, ...)
{
	...
	if (dprec_logger_len[type][dprec_logger_id[type]] < 64) {
		...
		dprec_logger_id[type] = dprec_logger_id[type] % dprec_logger_prop[type][1];
		dprec_logger_len[type][dprec_logger_id[type]] = dprec_logger_prop[type][0];
	}

	buf = dprec_logger_buffer[type][dprec_logger_id[type]] +
		dprec_logger_prop[type][0] - dprec_logger_len[type][dprec_logger_id[type]];
