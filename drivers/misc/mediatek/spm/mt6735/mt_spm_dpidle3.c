...
#define WAKE_SRC_FOR_DPIDLE                                                                      \
	...
	WAKE_SRC_SEJ | WAKE_SRC_AFE | WAKE_SRC_CIRQ | WAKE_SRC_MD1_VRF18_WAKE | WAKE_SRC_SYSPWREQ | \
...
*/
	...
	spm_write(SPM_PCM_RESERVE3,
			(pmic_get_register_value(PMIC_VSRAM_VOSEL_OFFSET) << 8)
				| pmic_get_register_value(PMIC_VSRAM_VOSEL_DELTA)); /* delta = 0v */
