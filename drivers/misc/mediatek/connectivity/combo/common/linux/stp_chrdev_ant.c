...
static PINT8 ANT_BUILT_IN_PATCH_FILE_NAME_E1 = "/android/system/etc/firmware/ANT_RAM_CODE_E1.BIN";
static PINT8 ANT_BUILT_IN_PATCH_FILE_NAME_E2 = "/android/system/etc/firmware/ANT_RAM_CODE_E2.BIN";
