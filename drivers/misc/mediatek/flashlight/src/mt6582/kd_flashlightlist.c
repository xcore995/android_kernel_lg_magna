...
{
    unsigned int e_CAMERA_SENSOR = 0;
    PK_DBG("[flashlight_shutdown] start\n");
    e_CAMERA_SENSOR = e_CAMERA_MAIN_SENSOR;
    kdSetFlashlightDrv((unsigned int*)&e_CAMERA_SENSOR); /* e_CAMERA_MAIN_SENSOR */
    g_pFlashlightFunc->flashlight_release(0);
    e_CAMERA_SENSOR = e_CAMERA_SUB_SENSOR;
    kdSetFlashlightDrv((unsigned int*)&e_CAMERA_SENSOR); /* e_CAMERA_SUB_SENSOR */
    g_pFlashlightFunc->flashlight_release(0);
    g_pFlashlightFunc = NULL;
    PK_DBG("[flashlight_shutdown] Done\n");
}
