...
static struct i2c_board_info kd_lens_dev __initdata = { I2C_BOARD_INFO("DW9714A", 0x19) }; //[LGE_UPDATE][yonghwan.lym@lge.com][2015-01-02] Multiple EEPROM Suport


#define DW9714A_DRVNAME "DW9714A"
#define DW9714A_VCM_WRITE_ID           0x19 //[LGE_UPDATE][yonghwan.lym@lge.com][2015-01-02] Multiple EEPROM Suport

#define DW9714A_DEBUG
#ifdef DW9714A_DEBUG
#define DW9714ADB printk //[LGE_UPDATE][yonghwan.lym@lge.com][2014-12-16] af kernel log enable
#else
#define DW9714ADB(x, ...)
#endif
...
inline static int Register_DW9714A_CharDrv(void)
{
	...
	actuator_class = class_create(THIS_MODULE, "actuatordrv1"); //[LGE_UPDATE][yonghwan.lym@lge.com][2015-01-02] Multiple EEPROM Suport
...
static struct platform_driver g_stDW9714A_Driver = {
	...
	.driver = {
		   .name = "lens_actuator1", //[LGE_UPDATE][yonghwan.lym@lge.com][2015-01-02] Multiple EEPROM Suport
		   .owner = THIS_MODULE,
		   }
};
