			     ...
			     unsigned long *delay_off)
{
	...
	cancel_work_sync(&led_data->work);	//Y90 TD#166436..LED_constant_On(at_times) //MTK to confirm the patch
...
static ISINK0_LED_Breathmode_set_table led_scene_setting[] = {
	/*step duty fsel tr1 tr2 tf1 tf2 ton toff */
	{0x01, 31, 999, 4, 10, 4, 10, 3, 0},// 0.charging
	{0x01, 31, 999,  1, 5, 1, 5, 3, 0},// 1.Power on
	{0x01, 31, 999,  1, 5, 1, 5, 3, 0},// 2.Power off
	{0x01, 31, 999,  0, 0, 0, 0, 0, 0},// 3.Alarm
	{0x01, 31, 999,  0, 1, 0, 1, 0, 0},// 4.Incomming call
	{0x01, 31, 999,  0, 0, 0, 0, 0, 0},// 5.Urgent Incomming call
	{0x01, 31, 999,  1, 2, 1, 2, 3, 2},// 6.In call
	...
	{0x01, 31, 999,  1, 5, 1, 5, 3, 0},// 9.default
};
