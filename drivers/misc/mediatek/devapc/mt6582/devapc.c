       ...
       switch (apc_index){
            ...
            case 5:
                ...
                *DEVAPC0_D0_APC_5 |= permission_control << (2 * apc_bit_index);
                break;
            default:
                pr_debug( "Set_Module_APC : The setting is error, please check if setting is correct or not !\n");
         }
    }
...
static void unmask_module_irq(unsigned int module)
{
    ...
    switch (apc_index){
       ...
       default:
           pr_debug( "UnMask_Module_IRQ : The setting is error, please check if domain master setting is correct or not !\n");
           break;
    }
