 ...
 kal_uint32 charging_parameter_to_value(const kal_uint32 *parameter, const kal_uint32 array_size, const kal_uint32 val)
{
 ...
 static void hw_bc11_dump_register(void)
 {
	...
	for(i=reg_num ; i<=CHR_CON19 ; i+=2)
	{
		...
		battery_log(BAT_LOG_CRTI, "Chr Reg[0x%x]=0x%x \r\n", i, reg_val);
	}
 }
 ...
 static void hw_bc11_init(void)
 {
    ...
    {
		battery_log(BAT_LOG_CRTI, "hw_bc11_init() \r\n");
 ...
 static U32 hw_bc11_DCD(void)
 {
	...
	if(Enable_BATDRV_LOG == BAT_LOG_FULL)
    {
		battery_log(BAT_LOG_CRTI, "hw_bc11_DCD() \r\n");
		hw_bc11_dump_register();
    }
 ...
 static U32 hw_bc11_stepA1(void)
 {
	...
	if(Enable_BATDRV_LOG == BAT_LOG_FULL)
    {
		battery_log(BAT_LOG_CRTI, "hw_bc11_stepA1() \r\n");
		hw_bc11_dump_register();
    }
 ...
 static U32 hw_bc11_stepB1(void)
 {
	...
	if(Enable_BATDRV_LOG == BAT_LOG_FULL)
    {
		battery_log(BAT_LOG_CRTI, "hw_bc11_stepB1() \r\n");
		hw_bc11_dump_register();
    }
 ...
 static U32 hw_bc11_stepC1(void)
 {
	...
	if(Enable_BATDRV_LOG == BAT_LOG_FULL)
    {
		battery_log(BAT_LOG_CRTI, "hw_bc11_stepC1() \r\n");
		hw_bc11_dump_register();
    }
 ...
 static U32 hw_bc11_stepA2(void)
 {
	...
	if(Enable_BATDRV_LOG == BAT_LOG_FULL)
    {
		battery_log(BAT_LOG_CRTI, "hw_bc11_stepA2() \r\n");
		hw_bc11_dump_register();
    }
 ...
 static U32 hw_bc11_stepB2(void)
 {
	...
	if(Enable_BATDRV_LOG == BAT_LOG_FULL)
    {
		battery_log(BAT_LOG_CRTI, "hw_bc11_stepB2() \r\n");
		hw_bc11_dump_register();
    }
 ...
 static void hw_bc11_done(void)
 {
	...
	if(Enable_BATDRV_LOG == BAT_LOG_FULL)
    {
		battery_log(BAT_LOG_CRTI, "hw_bc11_done() \r\n");
		hw_bc11_dump_register();
    }
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
	...
	battery_log(BAT_LOG_CRTI, "[%s][SNB1058]gpio_number=0x%x,gpio_mode=%d\n", __func__, gpio_number, gpio_mode);
 ...
 static kal_uint32 charging_enable(void *data)
 {
	...
	battery_log(BAT_LOG_CRTI, "[%s][SNB1058] charger enable = %d, chg_type = %d \r\n", __func__, enable, chg_type);
 ...
 static kal_uint32 charging_set_cv_voltage(void *data)
 {
    ...
    /* TO DO */
	battery_log(BAT_LOG_CRTI, "[%s][SNB1058] NO Action! \r\n", __func__);
 ...
 static kal_uint32 charging_set_current(void *data)
 {
	...
	battery_log(BAT_LOG_CRTI, "[%s][SNB1058] current_value = %d, chg_type = %d \r\n",
 ...
 static kal_uint32 charging_set_input_current(void *data)
 {
	...
	battery_log(BAT_LOG_CRTI, "[%s][SNB1058] input_current_value = %d \r\n", __func__, current_value);
 ...
 static kal_uint32 charging_get_charging_status(void *data)
 {
    ...
    *(kal_uint32 *)data = check_EOC_status();
	...
	battery_log(BAT_LOG_CRTI, "[%s][SNB1058] EOC_status = %d \r\n", __func__, *(kal_uint32 *)data);
 ...
 static kal_uint32 charging_set_hv_threshold(void *data)
 {
	...
	battery_log(BAT_LOG_CRTI, "[%s][SNB1058] VCDT register_value = %d\r\n", __func__, register_value);
  ...
  static kal_uint32 charging_get_hv_status(void *data)
  {
	   ...
	   *(kal_bool*)(data) = upmu_get_rgs_vcdt_hv_det();
		...
		battery_log(BAT_LOG_CRTI, "[%s][SNB1058] hv_status = %d\r\n", __func__, *(kal_bool *)(data));
 ...
 static kal_uint32 charging_get_charger_det_status(void *data)
 {
	   ...
	   *(kal_bool*)(data) = upmu_get_rgs_chrdet();
       ...
       if( upmu_get_rgs_chrdet() == 0 )
		...
		battery_log(BAT_LOG_CRTI, "[%s][SNB1058] g_charger_type = %d\r\n", __func__, g_charger_type);
 ...
 */
 kal_int32 chr_control_interface(CHARGING_CTRL_CMD cmd, void *data)
 {
	 ...
	 {
		battery_log(BAT_LOG_CRTI, "[%s][SNB1058] get interface fail!!!\r\n", __func__);
