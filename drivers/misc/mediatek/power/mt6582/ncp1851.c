...
kal_uint32 ncp1851_read_interface (kal_uint8 RegNum, kal_uint8 *val, kal_uint8 MASK, kal_uint8 SHIFT)
{
	...
	battery_log(BAT_LOG_CRTI, "[ncp1851_read_interface] Reg[%x]=0x%x\n", RegNum, ncp1851_reg);

    ncp1851_reg &= (MASK << SHIFT);
    *val = (ncp1851_reg >> SHIFT);
	battery_log(BAT_LOG_CRTI, "[ncp1851_read_interface] Val=0x%x\n", *val);
...
kal_uint32 ncp1851_config_interface (kal_uint8 RegNum, kal_uint8 val, kal_uint8 MASK, kal_uint8 SHIFT)
{
    ...
    ret = ncp1851_read_byte(RegNum, &ncp1851_reg);
	/*battery_log(BAT_LOG_CRTI, "[ncp1851_config_interface] Reg[%x]=0x%x\n", RegNum, ncp1851_reg);*/

    ncp1851_reg &= ~(MASK << SHIFT);
    ncp1851_reg |= (val << SHIFT);

    ret = ncp1851_write_byte(RegNum, ncp1851_reg);
	/*battery_log(BAT_LOG_CRTI, "[ncp18516_config_interface] Write Reg[%x]=0x%x\n", RegNum, ncp1851_reg);*/

    // Check
    //ncp1851_read_byte(RegNum, &ncp1851_reg);
	/*battery_log(BAT_LOG_CRTI, "[ncp1851_config_interface] Check Reg[%x]=0x%x\n", RegNum, ncp1851_reg);*/
...
{
    ncp1851_read_byte(i, &ncp1851_reg[i]);
	battery_log(BAT_LOG_CRTI, "[ncp1851_read_register] Reg[0x%X]=0x%X\n", i, ncp1851_reg[i]);
}
