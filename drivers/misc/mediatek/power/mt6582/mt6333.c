...
static int mt6333_thread_kthread(void *x)
{
    ...
    while (1) {
		...
		battery_log(BAT_LOG_CRTI,  "[INT] int_status_val_0=0x%x\n", int_status_val_0);
		...
		battery_log(BAT_LOG_CRTI,  "[INT] int_status_val_1=0x%x\n", int_status_val_1);
		...
		battery_log(BAT_LOG_CRTI,  "[INT] int_status_val_2=0x%x\n", int_status_val_2);
...
void MT6333_EINT_SETTING(void)
{
	...
	/*battery_log(BAT_LOG_CRTI,  "[CUST_EINT] CUST_EINT_MT6333_PMIC_POLARITY=%d\n",
		CUST_EINT_MT6333_PMIC_POLARITY);*/
	/*battery_log(BAT_LOG_CRTI, "[CUST_EINT] CUST_EINT_MT6333_PMIC_SENSITIVE=%d\n",
		CUST_EINT_MT6333_PMIC_SENSITIVE);*/
...
void read_adc_value(int index)
{
    ...
    if(index == 0) //vcore
    {
		battery_log(BAT_LOG_CRTI, "Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,\
		Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x\n",
...
void exec_vcore_dlc_subtest(void)
{
    ...
    for(i=0;i<=MT6333_PMIC_VCORE_DLC_SLEEP_MASK;i++)
    {
		...
		battery_log(BAT_LOG_CRTI, "[exec_vcore_dlc_subtest] mt6333_set_vcore_dlc_sleep=%d,
			mt6333_set_vcore_dlc_n_sleep=%d\n", i, i);

		battery_log(BAT_LOG_CRTI, "[exec_vcore_dlc_subtest] mt6333_get_qi_vcore_dlc=%d,
			mt6333_get_qi_vcore_dlc_n=%d\n",
    ...
    for(i=0;i<=MT6333_PMIC_VCORE_DLC_ON_MASK;i++)
    {
		...
		battery_log(BAT_LOG_CRTI, "[exec_vcore_dlc_subtest] mt6333_set_vcore_dlc_on=%d,
			mt6333_set_vcore_dlc_n_on=%d\n", i, i);
...
void exec_vmem_dlc_subtest(void)
{
    ...
    for(i=0;i<=MT6333_PMIC_VMEM_DLC_SLEEP_MASK;i++)
    {
		...
		battery_log(BAT_LOG_CRTI, "[exec_vmem_dlc_subtest] mt6333_set_vmem_dlc_sleep=%d,
			mt6333_set_vmem_dlc_n_sleep=%d\n", i, i);

		battery_log(BAT_LOG_CRTI, "[exec_vmem_dlc_subtest] mt6333_get_qi_vmem_dlc=%d,
			mt6333_get_qi_vmem_dlc_n=%d\n",
    ...
    for(i=0;i<=MT6333_PMIC_VMEM_DLC_ON_MASK;i++)
    {
		...
		battery_log(BAT_LOG_CRTI, "[exec_vmem_dlc_subtest] mt6333_set_vmem_dlc_on=%d,
			mt6333_set_vmem_dlc_n_on=%d\n", i, i);
...
void exec_vrf18_dlc_subtest(void)
{
    ...
    for(i=0;i<=MT6333_PMIC_VRF18_DLC_SLEEP_MASK;i++)
    {
		...
		battery_log(BAT_LOG_CRTI, "[exec_vrf18_dlc_subtest] mt6333_set_vrf18_dlc_sleep=%d,
			mt6333_set_vrf18_dlc_n_sleep=%d\n", i, i);

		battery_log(BAT_LOG_CRTI, "[exec_vrf18_dlc_subtest] mt6333_get_qi_vrf18_dlc=%d,
			mt6333_get_qi_vrf18_dlc_n=%d\n",
    ...
    for(i=0;i<=MT6333_PMIC_VRF18_DLC_ON_MASK;i++)
    {
		...
		battery_log(BAT_LOG_CRTI, "[exec_vrf18_dlc_subtest] mt6333_set_vrf18_dlc_on=%d,
			mt6333_set_vrf18_dlc_n_on=%d\n", i, i);
        ...
        switch(i){
            case 0:
                for(j=0;j<=MT6333_PMIC_VCORE_DLC_MASK;j++)
                {
                    ...
                    {
						battery_log(BAT_LOG_CRTI, "[exec_vcore_dlc_test]
							fail at mt6333_get_qi_vcore_dlc=%d,
							mt6333_get_qi_vcore_dlc_n=%d\n",
                            mt6333_get_qi_vcore_dlc(), mt6333_get_qi_vcore_dlc_n());
                    }

					battery_log(BAT_LOG_CRTI, "[exec_vcore_dlc_test]
						mt6333_set_vcore_dlc=%d,mt6333_set_vcore_dlc_n=%d,
						mt6333_get_qi_vcore_dlc=%d, mt6333_get_qi_vcore_dlc_n=%d\n",
        ...
        switch(i){
            case 0:
                for(j=0;j<=MT6333_PMIC_VMEM_DLC_MASK;j++)
                {
                    ...
                    {
						battery_log(BAT_LOG_CRTI, "[exec_vmem_dlc_test]
							fail at mt6333_get_qi_vmem_dlc=%d,
							mt6333_get_qi_vmem_dlc_n=%d\n",
                            mt6333_get_qi_vmem_dlc(), mt6333_get_qi_vmem_dlc_n());
                    }

					battery_log(BAT_LOG_CRTI, "[exec_vmem_dlc_test]
						mt6333_set_vmem_dlc=%d, mt6333_set_vmem_dlc_n=%d,
						mt6333_get_qi_vmem_dlc=%d, mt6333_get_qi_vmem_dlc_n=%d\n",
        ...
        switch(i){
            case 0:
                for(j=0;j<=MT6333_PMIC_VRF18_DLC_MASK;j++)
                {
                    ...
                    {
						battery_log(BAT_LOG_CRTI, "[exec_vrf18_dlc_test]
							fail at mt6333_get_qi_vrf18_dlc=%d,
							mt6333_get_qi_vrf18_dlc_n=%d\n",
                            mt6333_get_qi_vrf18_dlc(), mt6333_get_qi_vrf18_dlc_n());
                    }

					battery_log(BAT_LOG_CRTI, "[exec_vrf18_dlc_test]
						mt6333_set_vrf18_dlc=%d,mt6333_set_vrf18_dlc_n=%d,
						mt6333_get_qi_vrf18_dlc=%d, mt6333_get_qi_vrf18_dlc_n=%d\n",
        ...
        switch(i){
            case 0:
                for(j=0;j<=MT6333_PMIC_VCORE_BURST_MASK;j++)
                {
                    ...
                    {
						battery_log(BAT_LOG_CRTI, "[exec_vcore_burst_test]
							fail at mt6333_get_qi_vcore_burst=%d\n",
                            mt6333_get_qi_vcore_burst());
                    }

					battery_log(BAT_LOG_CRTI, "[exec_vcore_burst_test] mt6333_set_vcore_burst=%d,
						mt6333_get_qi_vcore_burst=%d\n",
        ...
        switch(i){
            case 0:
                for(j=0;j<=MT6333_PMIC_VMEM_BURST_MASK;j++)
                {
                    ...
                    {
						battery_log(BAT_LOG_CRTI, "[exec_vmem_burst_test]
							fail at mt6333_get_qi_vmem_burst=%d\n",
                            mt6333_get_qi_vmem_burst());
                    }

					battery_log(BAT_LOG_CRTI, "[exec_vmem_burst_test] mt6333_set_vmem_burst=%d,
						mt6333_get_qi_vmem_burst=%d\n",
...
void tc_3112(void)
{
	...
	battery_log(BAT_LOG_CRTI, "[tc_3112] 1.1.2 Check PWM, CP and M3 status after charger plug-in at CC mode
		(RG_CHR_EN=1 and 3.0V < VBAT < CV_Vth)\n");
...
void tc_3113(void)
{
	...
	battery_log(BAT_LOG_CRTI, "[tc_3113] 1.1.3 Check PWM, CP and M3 status at chr_suspend mode
		(RG_CHR_EN=0 and CC_FLAG,3.4V < VBAT < CV_Vth)\n");
...
void tc_3121(void)
{
	...
	battery_log(BAT_LOG_CRTI, "[tc_3121] // 1.2.1 Set charger to auto-pwron state,
		and leave auto-pwron state by RG_USBDL_MODE_B\n");
...
void tc_3122(void)
{
	battery_log(BAT_LOG_CRTI, "[tc_3122] 1.2.2 Set charger to auto-pwron state,
		and leave auto-pwron state by watchdog timeout\n");
...
void tc_3123(void)
{
	...
	battery_log(BAT_LOG_CRTI, "[tc_3123] Check if unable to enter auto-pwron state
		once leave auto-pwron state without charger plug-out\n");
...
void tc_3211(void)
{
	...
	battery_log(BAT_LOG_CRTI, "[tc_3211] // -- 2.1.1 OTG mode on/off by setting RG_OTG_EN,
		check the power-on sequence d/a flags\n");
...
void tc_3311(void)
{
	...
	battery_log(BAT_LOG_CRTI, "[tc_3311] // -- 3.1.1 Flash light mode on/off
		by setting RG_FLASH_DRV_EN, check the power-on sequence d/a flags\n");
...
static ssize_t store_mt6333_access(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
        ...
        else
        {
			...
			battery_log(BAT_LOG_CRTI, "[store_mt6333_access] Please use \
				\"cat mt6333_access\" to get value\r\n");
        }
    }
    return size;
}
...
void MT6333_PMIC_INIT_SETTING_V1(void)
{
    ...
    {
		battery_log(BAT_LOG_CRTI,  "[MT6333_PMIC_INIT_SETTING_V1] PMIC Chip = %x\n", g_mt6333_cid);
		battery_log(BAT_LOG_CRTI,  "[MT6333_PMIC_INIT_SETTING_V1] 20130514\n");
    ...
    {
		battery_log(BAT_LOG_CRTI,  "[MT6333_PMIC_INIT_SETTING_V1] Unknown PMIC Chip (%x)\n", g_mt6333_cid);
    }

	battery_log(BAT_LOG_CRTI,  "after MT6333 init : Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,
		Reg[%x]=0x%x\n",
    ...
    // DCT
	battery_log(BAT_LOG_CRTI,  "[MT6333_PMIC_INIT_SETTING_V1] pmu_drv_tool_customization_init\n");
...
static int mt6333_driver_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	battery_log(BAT_LOG_CRTI,  "[MT6333_PMIC_INIT_SETTING_V1] Done\n");
