...
static swtp_state_type swtp_state_reg[SWTP_CTRL_MAX_STATE] = {
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_NONE, 2 G_NONE)},	/* SWTP_CTRL_USER_SET0 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_NONE, 2 G_TABLE0)},	/* SWTP_CTRL_USER_SET1 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_NONE, 2 G_TABLE1)},	/* SWTP_CTRL_USER_SET2 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_NONE, 2 G_TABLEX)},	/* SWTP_CTRL_USER_SET3 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_TABLE0, 2 G_NONE)},	/* SWTP_CTRL_USER_SET4 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_TABLE0, 2 G_TABLE0)},	/* SWTP_CTRL_USER_SET5 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_TABLE0, 2 G_TABLE1)},	/* SWTP_CTRL_USER_SET6 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_TABLE0, 2 G_TABLEX)},	/* SWTP_CTRL_USER_SET7 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_TABLE1, 2 G_NONE)},	/* SWTP_CTRL_USER_SET8 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_TABLE1, 2 G_TABLE0)},	/* SWTP_CTRL_USER_SET9 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_TABLE1, 2 G_TABLE1)},	/* SWTP_CTRL_USER_SET10 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_TABLE1, 2 G_TABLEX)},	/* SWTP_CTRL_USER_SET11 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_TABLEX, 2 G_NONE)},	/* SWTP_CTRL_USER_SET12 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_TABLEX, 2 G_TABLE0)},	/* SWTP_CTRL_USER_SET13 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_TABLEX, 2 G_TABLE1)},	/* SWTP_CTRL_USER_SET14 */
	{SWTP_MODE_OFF, SWTP_NORMAL_MODE, MODE_SWTP(3 G_TABLEX, 2 G_TABLEX)},	/* SWTP_CTRL_USER_SET15 */

	{SWTP_MODE_OFF, SWTP_SUPER_MODE, MODE_SWTP(3 G_NONE, 2 G_NONE)}	/* SWTP_CTRL_SUPER_SET */
};
...
static int swtp_state_machine(void *handle)
{
	...
	while (1) {
		...
		if (super_mode < SWTP_CTRL_MAX_STATE)
			...
			pr_err("[swtp]: swtp_reset_tx_power\n");
			swtp_reset_tx_power();
			continue;
		}
...
{
	pr_err("[swtp] swtp_mode_update_handler  md_id[%d], data[%d]\n", md_id, data);
...
static int __init swtp_mod_init(void)
{
	...
	pr_err("[swtp_tr] running swtp thread\n");
