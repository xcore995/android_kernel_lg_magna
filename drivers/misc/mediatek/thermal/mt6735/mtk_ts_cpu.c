...
*=============================================================*/
#if !defined(CONFIG_MTK_LEGACY)
static struct clk *therm_main;           /* main clock for Thermal*/
...
#if 0 //debug
{
    ...
    //if(cunt==0)  tscpu_printk("[Power/CPU_Thermal]0 hw_protect temp=%d\n",temp1);
    while(temp1 <= 3000 && cunt <20){
		cunt++;
    	tscpu_printk("[Power/CPU_Thermal]0 hw_protect temp=%d%d\n",temp1,__LINE__);
        temp1 = DRV_Reg32(TEMPMSR0)& 0x0fff;
    ...
    //if(cunt==0)  tscpu_printk("[Power/CPU_Thermal]1 hw_protect temp=%d\n",temp1);
    while(temp1 <= 3000 &&  cunt <20){
		cunt++;
    	tscpu_printk("[Power/CPU_Thermal]1 hw_protect temp=%d%d\n",temp1,__LINE__);
        temp1 = DRV_Reg32(TEMPMSR1)& 0x0fff;
        tscpu_printk("TS_CON1=0x%x\n",DRV_Reg32(TS_CON1));
    	udelay(2);
	}
    ...
    //if(cunt==0) tscpu_printk("[Power/CPU_Thermal]2 hw_protect temp=%d\n",temp1);
    while(temp1 <= 3000 &&  cunt <20){
		cunt++;
    	tscpu_printk("[Power/CPU_Thermal]2 hw_protect temp=%d%d\n",temp1,__LINE__);
        temp1 = DRV_Reg32(TEMPMSR2)& 0x0fff;
        tscpu_printk("TS_CON1=0x%x\n",DRV_Reg32(TS_CON1));
    	udelay(2);
	}
    ...
    //if(cunt==0)    tscpu_printk("[Power/CPU_Thermal]3 hw_protect temp=%d\n",temp1);
    while(temp1 <= 3000 &&  cunt <20){
		cunt++;
    	tscpu_printk("[Power/CPU_Thermal]3 hw_protect temp=%d,%d\n",temp1,__LINE__);
        temp1 = DRV_Reg32(TEMPMSR3)& 0x0fff;
        tscpu_printk("TS_CON1=0x%x\n",DRV_Reg32(TS_CON1));
    	udelay(2);
	}
...
*/
	...
	if((curr_temp > (trip_temp[0] - 15000)) || (curr_temp<-30000))
		tscpu_printk("[Power/CPU_Thermal] CPU T=%d\n",curr_temp);
#endif
...
//    UINT32 temp1 = 0,temp2 = 0,temp3 = 0,count=0;
    ...
    while(temp!=0xDA1 && cunt <20){
		cunt++;
    	//tscpu_printk("[Power/CPU_Thermal]0 temp=%d,cunt=%d\n",temp,cunt);
        temp = DRV_Reg32(TEMPMSR0)& 0x0fff;
	}
    ...
    while(temp!=0xDA1 &&  cunt <20){
		cunt++;
    	//tscpu_printk("[Power/CPU_Thermal]1 temp=%d,cunt=%d\n",temp,cunt);
        temp = DRV_Reg32(TEMPMSR1)& 0x0fff;
	}
    ...
    while(temp!=0xDA1 &&  cunt <20){
		cunt++;
    	//tscpu_printk("[Power/CPU_Thermal]2 temp=%d,cunt=%d\n",temp,cunt);
        temp = DRV_Reg32(TEMPMSR2)& 0x0fff;
	}
    ...
    while(temp!=0xDA1 &&  cunt <20){
		cunt++;
    	//tscpu_printk("[Power/CPU_Thermal]3 temp=%d,cunt=%d\n",temp,cunt);
        temp = DRV_Reg32(TEMPMSR3)& 0x0fff;
	}
...
//	DRV_WriteReg32(TEMPSPARE2, temp);        // set sensor voltage and sensor valid
	...
	tscpu_printk(KERN_CRIT "thermal_DBG  thermal_fast_init TEMPMSR0=%x,TEMPMSR1=%x,TEMPMSR2=%x,TEMPMSR3=%x\n",
...
static int tscpu_thermal_probe(struct platform_device *dev)
{
	...
	*/
	...
	//tscpu_printk(KERN_CRIT "cnt = %d, %d\n",cnt,__LINE__);
...
static int create_profs_nodes(void)
{
