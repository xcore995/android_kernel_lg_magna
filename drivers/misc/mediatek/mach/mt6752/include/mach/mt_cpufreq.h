...
CPUFREQ_EXTERN void mt_cpufreq_set_pmic_cmd_full(enum pmic_wrap_phase_id phase, int idx, unsigned int cmd_addr, unsigned int cmd_wdata);
...
CPUFREQ_EXTERN void mt_cpufreq_set_min_freq(enum mt_cpu_dvfs_id id, unsigned int freq);
CPUFREQ_EXTERN void mt_cpufreq_set_max_freq(enum mt_cpu_dvfs_id id, unsigned int freq);
