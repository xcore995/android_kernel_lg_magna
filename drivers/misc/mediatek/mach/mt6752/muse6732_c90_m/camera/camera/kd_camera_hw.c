...
// LGE_CHANGE_S: [2014-11-03] youmi.jun@lge.com, Add camera
    ...
    // LGE_CHANGE_S: [2015-1-31] youmi.jun@lge.com, Modify HI841 power sequence
    ...
    // LGE_CHANGE_E: [2015-1-31] youmi.jun@lge.com, Modify HI841 power sequence
// LGE_CHANGE_E: [2014-11-03] youmi.jun@lge.com, Add camera
// LGE_CHANGE_S: [2015-1-31] youmi.jun@lge.com, Modify OV5670 power sequence
...
// LGE_CHANGE_E: [2015-1-31] youmi.jun@lge.com, Modify OV5670 power sequence
...
BOOL hwpowerdown(PowerInformation pwInfo, char* mode_name)
{
	...
	{
// LGE_CHANGE_S: [2015-1-31] youmi.jun@lge.com, Modify power sequence
        ...
        mdelay(2); //LGE_UPDATE [youmi.jun@lge.com] 2014/12/23, Add delay after reset
// LGE_CHANGE_E: [2015-1-31] youmi.jun@lge.com, Modify power sequence
	}
	else if(pwInfo.PowerType==SensorMCLK)
	{
		if(pinSetIdx==0)
