...
int __init mt_clkdbg_debug_init(void)
{
	...
	clkdbg_ops_prepare_enable("apll1");
	clkdbg_ops_disable_unprepare("apll1");
	clkdbg_ops_prepare_enable("apll2");
	clkdbg_ops_disable_unprepare("apll2");
	clkdbg_ops_prepare_enable("dpi0_sel");
	clkdbg_ops_disable_unprepare("dpi0_sel");
