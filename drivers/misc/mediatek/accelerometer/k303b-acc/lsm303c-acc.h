...
#define LSM303C_REG_DATA_FORMAT		0x23
#define LSM303C_REG_DATA_FILTER		0x21
#define LSM303C_REG_DATAX0			0x28
#define LSM303C_REG_REG5			0x24


#define LSM303C_REG_OFSX            0XFF

#define LSM303C_FIXED_DEVID			0x41

/* Accelerometer Sensor Full Scale */
#define	LSM303C_ACC_FS_MASK	(0x30)
#define LSM303C_ACC_FS_2G 	(0x00)	/* Full scale 2g */
#define LSM303C_ACC_FS_4G 	(0x20)	/* Full scale 4g */
#define LSM303C_ACC_FS_8G 	(0x30)	/* Full scale 8g */
...
//#define LSM303C_BW_200HZ			0x0C
//#define LSM303C_BW_100HZ			0x0B
//#define LSM303C_BW_50HZ				0x0A
/* ODR */
#define ODR_ACC_MASK		(0x70)	/* Mask for odr change on acc */
#define LSM303C_ACC_ODR_OFF	(0x00)  /* Power down */
#define LSM303C_ACC_ODR10	(0x10)  /* 25Hz output data rate */
#define LSM303C_ACC_ODR50	(0x20)  /* 50Hz output data rate */
#define LSM303C_ACC_ODR100	(0x30)  /* 100Hz output data rate */
#define LSM303C_ACC_ODR200	(0x40)  /* 200Hz output data rate */
#define LSM303C_ACC_ODR400	(0x50)  /* 400Hz output data rate */
#define LSM303C_ACC_ODR800	(0x60)  /* 1600Hz output data rate */
#define LSM303C_ACC_ODR_ENABLE (0x07)


/* Accelerometer Filter */
#define LSM303C_ACC_FILTER_MASK	(0xC0)
