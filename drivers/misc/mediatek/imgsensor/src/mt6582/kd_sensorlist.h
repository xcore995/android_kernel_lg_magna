...
UINT32 HI553_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); // LGE_CHANGE: [2015-09-09] yonghwan.lym@lge.com, Add camera(hi842,hi553)
...
/*HI*/
UINT32 HI842_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); // LGE_CHANGE: [2015-09-09] yonghwan.lym@lge.com, Add camera(hi842,hi553)
