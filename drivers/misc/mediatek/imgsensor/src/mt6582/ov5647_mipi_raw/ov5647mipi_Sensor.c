...
static void OV5647MIPI_Write_Shutter(kal_uint16 iShutter)
{
    ...
    SENSORDB("line_length[0x380c]0x:\n",OV5647MIPI_read_cmos_sensor(0x380c));
	SENSORDB("line_length[0x380d][%x]\n",OV5647MIPI_read_cmos_sensor(0x380d));
	SENSORDB("frame_height[0x380e][%x]\n",OV5647MIPI_read_cmos_sensor(0x380e));
	SENSORDB("frame_height[0x380d][%x]\n",OV5647MIPI_read_cmos_sensor(0x380d));


	SENSORDB("[OV5647_Write_Shutter]OV5647_sensor.pclk=%d\n",OV5647MIPI_sensor.pclk);
	SENSORDB("[OV5647_Write_Shutter]OV5647_sensor.line_length=%d\n",OV5647MIPI_sensor.line_length);
	SENSORDB("[OV5647_Write_Shutter]OV5647_sensor.frame_height=%d\n",OV5647MIPI_sensor.frame_height);
	SENSORDB("[OV5647_Write_Shutter]iShutter=%d\n",iShutter);
	...
	SENSORDB("[OV5647_Write_Shutter]fps=%d",fps);
			}
...
/*No Need to implement this function*/
	...
	SENSORDB("[soso][OV5647MIPI_night_mode]enable=%d",enable);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	msleep(40);
	//SENSORDB("[soso][OV5647MIPIPreview]shutter=%x,shutter=%d\n",OV5647MIPI_sensor.shutter,OV5647MIPI_sensor.shutter);
	return ERROR_NONE;
}   /*  OV5647MIPIPreview   */
