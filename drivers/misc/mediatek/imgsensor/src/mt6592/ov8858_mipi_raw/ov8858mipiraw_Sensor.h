...
typedef struct
{
    ...
    #define OV8858_PREVIEW_PCLK             (144000000)//(74400000)
    #define OV8858_VIDEO_PCLK                 (144000000)//(148800000)
    #define OV8858_CAPTURE_PCLK             (144000000)//(148800000)
...
//TODO~
    ...
    #define OV8858_PV_PERIOD_LINE_NUMS                   (2488)//(1284)

    #define OV8858_VIDEO_PERIOD_PIXEL_NUMS                (2566)
    #define OV8858_VIDEO_PERIOD_LINE_NUMS                (1872)//(1932)

    #define OV8858_FULL_PERIOD_PIXEL_NUMS                (1940)
    #define OV8858_FULL_PERIOD_LINE_NUMS                (2474)//(2556)
