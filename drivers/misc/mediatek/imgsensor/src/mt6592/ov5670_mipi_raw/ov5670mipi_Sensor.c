...
static kal_uint32 open(void)
{
    ...
    imgsensor.autoflicker_en= KAL_TRUE; //[LGE_UPDATE][yonghwan.lym@lge.com][2015-05-27] front camera flicker issue resolve - max fps
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    imgsensor.frame_length = imgsensor_info.pre.framelength;
    imgsensor.min_frame_length = imgsensor_info.pre.framelength;
    //imgsensor.autoflicker_en = KAL_FALSE; //[LGE_UPDATE][yonghwan.lym@lge.com][2015-05-27] front camera flicker issue resolve - max fps
    spin_unlock(&imgsensor_drv_lock);
    preview_setting();
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_SET_AUTO_FLICKER_MODE:
            //set_auto_flicker_mode((BOOL)*feature_data_16,*(feature_data_16+1)); //[LGE_UPDATE][yonghwan.lym@lge.com][2015-05-27] front camera flicker issue resolve - max fps
            break;
