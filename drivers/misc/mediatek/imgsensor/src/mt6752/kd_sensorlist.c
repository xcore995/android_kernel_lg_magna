...
static DEFINE_MUTEX(kdCam_i2c_Mutex);
...
//LGE_UPDATE_S [youmi.jun@lge.com] 2015/02/23, retry camera probing in case of failure
    UINT32 retry = 2;
    do {
//LGE_UPDATE_E [youmi.jun@lge.com] 2015/02/23, retry camera probing in case of failure
...
static int CAMERA_HW_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    /* set I2C clock rate */
    g_pstI2Cclient->timing = 200;//200k  //LGE_UPDATE [youmi.jun@lge.com] 2015/02/23, increase i2c clock (200KHz)
