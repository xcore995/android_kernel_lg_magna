...
#include <cust_battery_meter_table_TECHNOHILL.h>

/* Default Battery Profile */
INIT_BATTERY_PROFILE(LGC);

/* ID - Maker Maching */
DECLARE_PROFILE(DS2704_N, TECHNOHILL);		/* Not used */
DECLARE_PROFILE(DS2704_L, LGC);				/* Not used */
DECLARE_PROFILE(DS2704_C, TECHNOHILL);		/* Not used */
DECLARE_PROFILE(ISL6296_N, LGC);			/* Not used */
DECLARE_PROFILE(ISL6296_L, TECHNOHILL);		/* Not used */
DECLARE_PROFILE(ISL6296_C, LGC);			/* Not used */
DECLARE_PROFILE(RA4301_VC0, TECHNOHILL);
DECLARE_PROFILE(RA4301_VC1, LGC);
DECLARE_PROFILE(RA4301_VC2, TECHNOHILL);	/* Not used */
DECLARE_PROFILE(SW3800_VC0, LGC);
DECLARE_PROFILE(SW3800_VC1, TECHNOHILL);
